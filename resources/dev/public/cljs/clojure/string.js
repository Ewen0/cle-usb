...
{{
var G__161360 = cljs.core.pop.call(null,v__$1);
v__$1 = G__161360;
continue;
}
} else
...
{var pred__161364 = cljs.core._EQ_;var expr__161365 = limit;if(cljs.core.truth_(pred__161364.call(null,(1),expr__161365)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__161364.call(null,(2),expr__161365)))
...
var G__161367 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__161368 = (limit__$1 - (1));
var G__161369 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__161367;
limit__$1 = G__161368;
parts = G__161369;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___161371 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___161371))
{var replacement_161372 = temp__4124__auto___161371;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_161372)));
} else
{buffer.append(ch);
}
{
var G__161373 = (index + (1));
index = G__161373;
continue;
}
}
