...
goog.require('goog.events');
clojure.browser.event.IEventType = (function (){var obj160611 = {};return obj160611;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3636__auto__ = this$;if(and__3636__auto__)
...
{var x__4275__auto__ = (((this$ == null))?null:this$);return (function (){var or__3648__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4275__auto__)]);if(or__3648__auto__)
{return or__3648__auto__;
} else
{var or__3648__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3648__auto____$1)
...
return (function (p__160612){var vec__160613 = p__160612;var k = cljs.core.nth.call(null,vec__160613,(0),null);var v = cljs.core.nth.call(null,vec__160613,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__160614){var vec__160615 = p__160614;var k = cljs.core.nth.call(null,vec__160615,(0),null);var v = cljs.core.nth.call(null,vec__160615,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
