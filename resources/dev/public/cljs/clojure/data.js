...
{return cljs.core.reduce.call(null,(function (result,p__161657){var vec__161658 = p__161657;var k = cljs.core.nth.call(null,vec__161658,(0),null);var v = cljs.core.nth.call(null,vec__161658,(1),null);return cljs.core.assoc.call(null,result,k,v);
...
clojure.data.EqualityPartition = (function (){var obj161662 = {};return obj161662;
})();
clojure.data.equality_partition = (function equality_partition(x){if((function (){var and__3636__auto__ = x;if(and__3636__auto__)
...
{var x__4275__auto__ = (((x == null))?null:x);return (function (){var or__3648__auto__ = (clojure.data.equality_partition[goog.typeOf(x__4275__auto__)]);if(or__3648__auto__)
{return or__3648__auto__;
} else
{var or__3648__auto____$1 = (clojure.data.equality_partition["_"]);if(or__3648__auto____$1)
...
clojure.data.Diff = (function (){var obj161664 = {};return obj161664;
})();
clojure.data.diff_similar = (function diff_similar(a,b){if((function (){var and__3636__auto__ = a;if(and__3636__auto__)
...
{var x__4275__auto__ = (((a == null))?null:a);return (function (){var or__3648__auto__ = (clojure.data.diff_similar[goog.typeOf(x__4275__auto__)]);if(or__3648__auto__)
{return or__3648__auto__;
} else
{var or__3648__auto____$1 = (clojure.data.diff_similar["_"]);if(or__3648__auto____$1)
{return or__3648__auto____$1;
} else
...
(clojure.data.equality_partition["_"] = (function (x){if((function (){var G__161665 = x;if(G__161665)
{var bit__4298__auto__ = (G__161665.cljs$lang$protocol_mask$partition0$ & (1024));if((bit__4298__auto__) || (G__161665.cljs$core$IMap$))
{return true;
} else
{if((!G__161665.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__161665);
} else
{return false;
}
}
...
{if((function (){var G__161666 = x;if(G__161666)
{var bit__4298__auto__ = (G__161666.cljs$lang$protocol_mask$partition0$ & (4096));if((bit__4298__auto__) || (G__161666.cljs$core$ISet$))
{return true;
} else
{if((!G__161666.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__161666);
} else
{return false;
}
}
...
{if((function (){var G__161667 = x;if(G__161667)
{var bit__4298__auto__ = (G__161667.cljs$lang$protocol_mask$partition0$ & (16777216));if((bit__4298__auto__) || (G__161667.cljs$core$ISequential$))
{return true;
} else
{if((!G__161667.cljs$lang$protocol_mask$partition0$))
{return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__161667);
} else
{return false;
}
}
...
(clojure.data.diff_similar["_"] = (function (a,b){return (function (){var G__161668 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);switch (G__161668) {
case "map":
