...
datascript.btset.level_shift = (cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__156429_SHARP_){return ((datascript.btset.max_len & (1 << p1__156429_SHARP_)) != 0);
...
datascript.btset.cut_n_splice = (function cut_n_splice(arr,cut_from,cut_to,splice_from,splice_to,xs){var arr_l = arr.length;var xs_l = xs.length;var l1 = (splice_from - cut_from);var l2 = (cut_to - splice_to);var l1xs = (l1 + xs_l);var new_arr = (new Array(((l1 + xs_l) + l2)));var n__4504__auto___156446 = l1;var i_156447 = (0);while(true){
if((i_156447 < n__4504__auto___156446))
{(new_arr[i_156447] = (arr[(cut_from + i_156447)]));
{
var G__156448 = (i_156447 + (1));
i_156447 = G__156448;
continue;
}
} else
...
var n__4504__auto___156449 = xs_l;var i_156450 = (0);while(true){
if((i_156450 < n__4504__auto___156449))
{(new_arr[(i_156450 + l1)] = (xs[i_156450]));
{
var G__156451 = (i_156450 + (1));
i_156450 = G__156451;
continue;
}
} else
...
var n__4504__auto___156452 = l2;var i_156453 = (0);while(true){
if((i_156453 < n__4504__auto___156452))
{(new_arr[(i_156453 + l1xs)] = (arr[(splice_to + i_156453)]));
{
var G__156454 = (i_156453 + (1));
i_156453 = G__156454;
continue;
}
} else
...
datascript.btset.merge_n_split = (function merge_n_split(a1,a2){var a1_l = a1.length;var a2_l = a2.length;var total_l = (a1_l + a2_l);var r1_l = datascript.btset.half.call(null,total_l);var r2_l = (total_l - r1_l);var r1 = (new Array(r1_l));var r2 = (new Array(r2_l));var n__4504__auto___156455 = total_l;var i_156456 = (0);while(true){
if((i_156456 < n__4504__auto___156455))
{((((i_156456 < r1_l))?r1:r2)[(((i_156456 < r1_l))?i_156456:(i_156456 - r1_l))] = ((((i_156456 < a1_l))?a1:a2)[(((i_156456 < a1_l))?i_156456:(i_156456 - a1_l))]));
{
var G__156457 = (i_156456 + (1));
i_156456 = G__156457;
continue;
}
} else
...
datascript.btset.eq_arr = (function eq_arr(a1,a1_from,a1_to,a2,a2_from,a2_to,cmp){var len = (a1_to - a1_from);var and__3636__auto__ = (len === (a2_to - a2_from));if(and__3636__auto__)
{var i = (0);while(true){
if((i === len))
{return true;
} else
...
{if(cljs.core.truth_((function (){var and__3636__auto__ = left;if(cljs.core.truth_(and__3636__auto__))
...
{if(cljs.core.truth_((function (){var and__3636__auto__ = right;if(cljs.core.truth_(and__3636__auto__))
...
datascript.btset.Node.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"datascript.btset/Node");
});
...
datascript.btset.LeafNode.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"datascript.btset/LeafNode");
});
...
if((level > (0)))
{{
var G__156459 = (level - datascript.btset.level_shift);
var G__156460 = (node.pointers[datascript.btset.path_get.call(null,path,level)]);
level = G__156459;
node = G__156460;
continue;
}
...
datascript.btset.btset_conj = (function btset_conj(set,key){var _STAR_cmp_STAR_156462 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_156462;
}});
datascript.btset.btset_disj = (function btset_disj(set,key){var _STAR_cmp_STAR_156464 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
...
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_156464;
}});
...
datascript.btset.BTSetIter.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"datascript.btset/BTSetIter");
});
...
var G__156465 = (node.pointers[idx]);
var G__156466 = datascript.btset.path_set.call(null,path,level,idx);
var G__156467 = (level - datascript.btset.level_shift);
node = G__156465;
path = G__156466;
level = G__156467;
continue;
...
var G__156468 = (node.pointers[idx]);
var G__156469 = datascript.btset.path_set.call(null,path,level,idx);
var G__156470 = (level - datascript.btset.level_shift);
node = G__156468;
path = G__156469;
level = G__156470;
continue;
...
var slice__3 = (function (set,key_from,key_to){var _STAR_cmp_STAR_156472 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = set.comparator;
return datascript.btset._slice.call(null,set,key_from,key_to);
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_156472;
}});
...
datascript.btset.BTSet.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"datascript.btset/BTSet");
});
...
var ___$1 = this;var _STAR_cmp_STAR_156475 = datascript.btset._STAR_cmp_STAR_;try{datascript.btset._STAR_cmp_STAR_ = self__.comparator;
var or__3648__auto__ = self__.root.lookup(k);if(cljs.core.truth_(or__3648__auto__))
{return or__3648__auto__;
} else
{return not_found;
}
}finally {datascript.btset._STAR_cmp_STAR_ = _STAR_cmp_STAR_156475;
}});
...
{var h__4059__auto____$1 = cljs.core.hash_iset.call(null,coll__$1);self__.__hash = h__4059__auto____$1;
...
return (function (p1__156473_SHARP_){return cljs.core.contains_QMARK_.call(null,this$__$1,p1__156473_SHARP_);
});})(this$__$1))
,other));
});
...
var G__156476 = null;
var G__156476__2 = (function (self__,k){var self__ = this;
var self____$1 = this;var coll = self____$1;return coll.cljs$core$ILookup$_lookup$arity$2(null,k);
});
var G__156476__3 = (function (self__,k,not_found){var self__ = this;
var self____$1 = this;var coll = self____$1;return coll.cljs$core$ILookup$_lookup$arity$3(null,k,not_found);
});
G__156476 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__156476__2.call(this,self__,k);
case 3:
return G__156476__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__156476.cljs$core$IFn$_invoke$arity$2 = G__156476__2;
G__156476.cljs$core$IFn$_invoke$arity$3 = G__156476__3;
return G__156476;
})()
;
datascript.btset.BTSet.prototype.apply = (function (self__,args156474){var self__ = this;
var self____$1 = this;return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone.call(null,args156474)));
});
...
var G__156477__delegate = function (cmp,keys){return cljs.core.reduce.call(null,cljs.core._conj,btset_by.call(null,cmp),keys);
};
var G__156477 = function (cmp,var_args){
var keys = null;if (arguments.length > 1) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__156477__delegate.call(this,cmp,keys);};
G__156477.cljs$lang$maxFixedArity = 1;
G__156477.cljs$lang$applyTo = (function (arglist__156478){
var cmp = cljs.core.first(arglist__156478);
var keys = cljs.core.rest(arglist__156478);
return G__156477__delegate(cmp,keys);
});
G__156477.cljs$core$IFn$_invoke$arity$variadic = G__156477__delegate;
return G__156477;
})()
;
...
var G__156479__delegate = function (keys){return cljs.core.reduce.call(null,cljs.core._conj,btset.call(null),keys);
};
var G__156479 = function (var_args){
var keys = null;if (arguments.length > 0) {
  keys = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__156479__delegate.call(this,keys);};
G__156479.cljs$lang$maxFixedArity = 0;
G__156479.cljs$lang$applyTo = (function (arglist__156480){
var keys = cljs.core.seq(arglist__156480);
return G__156479__delegate(keys);
});
G__156479.cljs$core$IFn$_invoke$arity$variadic = G__156479__delegate;
return G__156479;
})()
;
