...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_160499 = (0);while(true){
if((i_160499 < arr.length))
{(arr[i_160499] = null);
{
var G__160500 = (i_160499 + (1));
i_160499 = G__160500;
continue;
}
} else
...
var G__160502 = x__$1;
var G__160503 = k;
var G__160504 = (level - (1));
var G__160505 = update;
x = G__160502;
k = G__160503;
level = G__160504;
update = G__160505;
...
{var i_160506 = (self__.level + (1));while(true){
if((i_160506 <= (new_level + (1))))
{(update[i_160506] = self__.header);
{
var G__160507 = (i_160506 + (1));
i_160506 = G__160507;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_160508 = (0);while(true){
if((i_160508 <= self__.level))
{var links_160509 = (update[i_160508]).forward;if(((links_160509[i_160508]) === x__$1))
{(links_160509[i_160508] = (x__$1.forward[i_160508]));
{
var G__160510 = (i_160508 + (1));
i_160508 = G__160510;
continue;
}
} else
{{
var G__160511 = (i_160508 + (1));
i_160508 = G__160511;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__3648__auto__ = (cljs.core.truth_((function (){var and__3636__auto__ = me;if(cljs.core.truth_(and__3636__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__3636__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__3648__auto__))
...
});})(timeout_channel,or__3648__auto__,timeout__$1,me))
,msecs);
