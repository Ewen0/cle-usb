...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t160598 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t160598 = (function (val,box,meta160599){
this.val = val;
this.box = box;
this.meta160599 = meta160599;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t160598.cljs$lang$type = true;
cljs.core.async.impl.channels.t160598.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t160598";
cljs.core.async.impl.channels.t160598.cljs$lang$ctorPrWriter = (function (this__4215__auto__,writer__4216__auto__,opt__4217__auto__){return cljs.core._write.call(null,writer__4216__auto__,"cljs.core.async.impl.channels/t160598");
});
cljs.core.async.impl.channels.t160598.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t160598.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_160600){var self__ = this;
var _160600__$1 = this;return self__.meta160599;
});
cljs.core.async.impl.channels.t160598.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_160600,meta160599__$1){var self__ = this;
var _160600__$1 = this;return (new cljs.core.async.impl.channels.t160598(self__.val,self__.box,meta160599__$1));
});
cljs.core.async.impl.channels.__GT_t160598 = (function __GT_t160598(val__$1,box__$1,meta160599){return (new cljs.core.async.impl.channels.t160598(val__$1,box__$1,meta160599));
});
}
return (new cljs.core.async.impl.channels.t160598(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_160601 = self__.takes.pop();if((taker_160601 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_160601))
{var take_cb_160602 = cljs.core.async.impl.protocols.commit.call(null,taker_160601);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_160602,taker_160601,this$__$1){
return (function (){return take_cb_160602.call(null,null);
});})(take_cb_160602,taker_160601,this$__$1))
);
} else
{}
{
...
var putter_160603 = self__.puts.pop();if(!((putter_160603 == null)))
{var put_handler_160604 = putter_160603.handler;var val_160605 = putter_160603.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_160604))
{var put_cb_160606 = cljs.core.async.impl.protocols.commit.call(null,put_handler_160604);var __160607__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_160606,__160607__$1,put_handler_160604,val_160605,putter_160603,_,retval,this$__$1){
return (function (){return put_cb_160606.call(null,true);
});})(put_cb_160606,__160607__$1,put_handler_160604,val_160605,putter_160603,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_160605);
} else
{{
continue;
}
