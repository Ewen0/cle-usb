...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_160592 = (0);while(true){
var m_160593 = cljs.core.async.impl.dispatch.tasks.pop();if((m_160593 == null))
{} else
{m_160593.call(null);
if((count_160592 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__160594 = (count_160592 + (1));
count_160592 = G__160594;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__3636__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__3636__auto__)
